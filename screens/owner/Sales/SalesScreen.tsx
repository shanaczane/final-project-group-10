    ...
    >
      ...
      {selected && (
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <Text style={[
              styles.infoValue,
              selected.quantity <= selected.min_threshold && styles.infoValueDanger,
            ]}>
        ...
        <>
          ...
          <View style={styles.stepper}>
            ...
            >
              <Ionicons
                name="add"
                size={22}
                color={quantity >= selected.quantity ? colors.textMuted : colors.textPrimary}
              />
            </Pressable>
          </View>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={[styles.summaryRow, styles.summaryRowLast]}>
              ...
              <Text style={[
                styles.summaryStock,
                stockAfter <= selected.min_threshold && styles.summaryStockLow,
              ]}>
                {stockAfter} units
              </Text>
            </View>
      ...
      {!selected && products.length === 0 && (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>No products available. Add products in Inventory first.</Text>
        </View>
      )}
