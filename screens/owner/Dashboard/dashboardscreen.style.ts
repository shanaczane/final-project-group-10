...
export function createStyles(colors: Colors) {
  return StyleSheet.create({
    ...
    restockBtn: { backgroundColor: colors.primary, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 7 },
    restockBtnText: { fontSize: 12, fontFamily: 'Manrope_600SemiBold', color: '#fff' },
    ...
    modalLabel: { fontSize: 13, fontFamily: 'Manrope_500Medium', color: colors.labelText, marginBottom: 8 },
    modalInput: { borderWidth: 1, borderColor: colors.border, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, color: colors.textPrimary, backgroundColor: colors.inputBackground },
    modalActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: 10, marginTop: 20 },
    cancelBtn: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10, backgroundColor: colors.cardBackground },
    cancelBtnText: { fontSize: 14, color: colors.textSecondary, fontFamily: 'Manrope_500Medium' },
    confirmBtn: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10, backgroundColor: colors.primary, minWidth: 80, alignItems: 'center' },
    confirmBtnText: { fontSize: 14, color: '#ffffff', fontFamily: 'Manrope_600SemiBold' },
