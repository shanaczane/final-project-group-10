...
export function createStyles(colors: Colors) {
  return StyleSheet.create({
    ...
    dateLabel: { fontSize: 12, color: colors.textMuted, fontWeight: '500' },
    storeName: { fontSize: 22, fontWeight: '800', color: colors.textPrimary, letterSpacing: -0.5, marginTop: 2 },
    ...
    heroValue: { fontSize: 36, fontWeight: '800', color: '#fff', letterSpacing: -1, marginTop: 4 },
    heroSubRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 4 },
    heroSub: { fontSize: 12, color: 'rgba(255,255,255,0.92)', fontWeight: '600' },
    barRow: { flexDirection: 'row', alignItems: 'flex-end', gap: 6, height: 50, marginTop: 14 },
    barCol: { flex: 1, alignItems: 'center', gap: 4 },
    bar: { width: '100%', borderRadius: 2 },
    barLabel: { fontSize: 9, color: 'rgba(255,255,255,0.7)', fontWeight: '600' },
    ...
    statLabel: { fontSize: 11, fontWeight: '600', color: colors.textMuted, letterSpacing: 0.6 },
    statValue: { fontSize: 28, fontWeight: '800', color: colors.textPrimary, letterSpacing: -0.8, marginTop: 6 },
    ...
    wideValue: { fontSize: 22, fontWeight: '800', color: colors.textPrimary, letterSpacing: -0.5, marginTop: 4 },
    ...
    qtyPillText: { fontSize: 16, fontWeight: '800', color: colors.danger },
    lowName: { fontSize: 14, fontWeight: '700', color: colors.textPrimary },
    lowSub: { fontSize: 11, color: colors.danger, fontWeight: '600', marginTop: 2 },
